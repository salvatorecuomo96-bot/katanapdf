...
13 phases. Each is one Claude session. Phase prompts live in [`phases/`](phases/).
...
| 4 | Unicode fonts | ⏳ Next | — | [04](phases/04-unicode-fonts.md) |
| 5 | Reorder pages | Pending | — | [05](phases/05-reorder-pages.md) |
| 6 | Delete + rotate pages | Pending | — | [06](phases/06-delete-rotate-pages.md) |
| 7 | Image to PDF | Pending | — | [07](phases/07-image-to-pdf.md) |
| 8 | Signature pad | Pending | — | [08](phases/08-signature-pad.md) |
| 9 | Per-page fallback + IndexedDB recovery | Pending | — | [09](phases/09-per-page-fallback.md) |
| 10 | Original text color | Pending | — | [10](phases/10-original-text-color.md) |
| 11 | SEO basics + per-tool routes | Pending | — | [11](phases/11-seo-basics.md) |
| 12 | Mobile-friendly pass (whole site) | Pending | — | [12](phases/12-mobile-friendly.md) |
| 13 | Pre-launch QA + ship | Pending | — | [13](phases/13-prelaunch-qa.md) |
...
- **When picking the next phase**, read only this `ROADMAP.md` (status table + rules) and the one phase file you're about to execute. Don't read all 13 phase files.
